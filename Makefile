...
#Libraries
LIBS += -L/usr/local/lib/ -L/usr/lib extern/jsoncpp-src-0.5.0/libs/linux-gcc-4.6/libjson_linux-gcc-4.6_libmt.so extern/gtest-1.7.0/make/gtest.a -lglut -lGL -lGLU -lpthread
